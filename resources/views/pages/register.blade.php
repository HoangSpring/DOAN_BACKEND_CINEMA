...
<style>
    ...
    .bokeh-1 { width: 300px; height: 300px; background: rgba(245, 197, 24, 0.15); top: 10%; left: 10%; animation-delay: 0s; }
    .bokeh-2 { width: 200px; height: 200px; background: rgba(245, 197, 24, 0.1); top: 60%; right: 15%; animation-delay: -5s; }
    .bokeh-3 { width: 250px; height: 250px; background: rgba(255, 215, 0, 0.08); bottom: 20%; left: 30%; animation-delay: -10s; }
    ...
    /* Hiệu ứng pulse cho các trường bắt buộc */
    .cinema-input:required:invalid:not(:placeholder-shown) {
...
<div class="container mx-auto px-4 py-12 flex justify-center items-center min-h-screen font-body relative z-10">
    <div class="w-full max-w-md cinema-card rounded-2xl p-8">
        <!-- Header -->
        <div class="text-center mb-6">
            <div class="cinema-title text-4xl font-bold mb-3">ĐĂNG KÝ</div>
            <p class="text-slate-400 text-sm tracking-wide">Tạo tài khoản để trải nghiệm đặt vé</p>
        ...
        <form method="POST" action="{{ url('/register') }}" class="space-y-5">
            ...
            <!-- Name Field -->
            <div>
                <label for="name" class="cinema-label mb-2">Họ và tên</label>
            ...
            <div>
                <label for="password_confirmation" class="cinema-label mb-2">Xác nhận mật khẩu</label>
                <div class="cinema-input-group">
                    <input 
                        type="password" 
            ...
            <!-- Submit Button -->
            <button type="submit" class="cinema-btn w-full flex justify-center items-center gap-2 py-3 rounded-lg text-base cursor-pointer mt-6">
                <span>🎬</span>
                <span>ĐĂNG KÝ</span>
                <span>→</span>
            </button>
        ...
        <div class="mt-8 text-center">
            ...
            <p class="text-sm text-slate-400">
                Đã có tài khoản? 
                <a href="{{ route('login') }}" class="cinema-link">Đăng nhập ngay</a>
            </p>
            <p class="text-xs text-slate-600 mt-2 italic">"Bước vào thế giới điện ảnh ngay hôm nay"</p>
        </div>
    </div>
</div>

<!-- Script để tạo thêm particles động và hiệu ứng form -->
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Hiệu ứng progress bar khi điền form
