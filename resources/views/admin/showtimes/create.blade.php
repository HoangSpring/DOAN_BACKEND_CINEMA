    ...
    <form action="{{ route('admin.showtimes.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="col-span-2 md:col-span-1">
                ...
                <select name="movie_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2 border" required>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <select name="room_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2 border" required>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="datetime-local" name="start_time" value="{{ old('start_time') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2 border" required>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="number" name="price_standard" value="{{ old('price_standard', 70000) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2 border" required min="0" step="1000">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="number" name="price_vip" value="{{ old('price_vip', 90000) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2 border" required min="0" step="1000">
                @error('price_vip') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
            </div>
        </div>

        <div class="mt-8 border-t pt-6">
            <button type="submit" class="w-full px-4 py-3 bg-indigo-600 text-white rounded font-bold hover:bg-indigo-500 shadow-lg text-lg">
                Tạo suất chiếu & Sinh sơ đồ ghế
            </button>
            <p class="text-center text-xs text-gray-500 mt-2">Hệ thống sẽ tự động tạo ghế cho suất chiếu này dựa trên sơ đồ phòng.</p>
        </div>
    </form>
</div>
@endsection
